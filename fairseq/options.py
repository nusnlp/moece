...
def add_preprocess_args(parser):
    ...
    # fmt: off
    group.add_argument('--add-specials', dest='special_chars', action='store_true',
                       help='add special symbols <s>, <pad>, </s>, and <unk> '
                            'at the beginning of dictionary')
    group.add_argument('--no-specials', dest='special_chars', action='store_false',
                       help='add special symbols <s>, <pad>, </s>, and <unk> '
                            'at the beginning of dictionary')
    parser.set_defaults(special_chars=True)
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--no-specials', dest='special_chars', action='store_false',
                       help='add special symbols <s>, <pad>, </s>, and <unk> '
                            'at the beginning of dictionary')
    parser.set_defaults(special_chars=True)
    group.add_argument('--decoder-start-token-idx', default=None, type=int, metavar='N',
                       help='Token index at the start of decoder input')
...
def add_optimization_args(parser):
    ...
    group.add_argument('--loss-denominator', default=None, type=int,
                       help='normalize gradients by a constant value instead of'
                            ' (default is to normalize by number of tokens)')
