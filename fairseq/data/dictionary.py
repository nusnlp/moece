...
class Dictionary(object):
    ...
    def add_symbol(self, word, n=1, overwrite=False):
        ...
        if word in self.indices and not overwrite:
            ...
            # print("{} not found in dict".format(word))
    ...
    @classmethod
    def load(cls, f, add_specials=True):
        ...
        ```
        """
        d = cls(add_specials=add_specials)
        d.add_from_file(f)
        if not add_specials:
            d.register_specials()
        return d
    ...
    def add_from_file(self, f):
        ...
        for line in lines[indices_start_line:]:
            try:
                ...
                # if line_id < 10:
                #     print(line_id, word, overwrite, self.symbols, self.indices)
                # line_id += 1
            except ValueError:
                raise ValueError(
