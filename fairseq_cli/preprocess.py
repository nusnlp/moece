...
def main(args):
    ...
    if args.joined_dictionary:
        ...
        if args.srcdict:
            src_dict = task.load_dictionary(args.srcdict, args.special_chars)
        elif args.tgtdict:
            src_dict = task.load_dictionary(args.tgtdict, args.special_chars)
        else:
        ...
        if args.srcdict:
            print('args.special_chars', args.special_chars)
            src_dict = task.load_dictionary(args.srcdict, args.special_chars)
        else:
            assert args.trainpref, "--trainpref must be set if --srcdict is not specified"
        ...
        if target:
            if args.tgtdict:
                print('args.special_chars', args.special_chars)
                tgt_dict = task.load_dictionary(args.tgtdict, args.special_chars)
            else:
